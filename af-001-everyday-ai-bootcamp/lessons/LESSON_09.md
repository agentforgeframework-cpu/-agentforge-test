...
This file is the authoritative instructional unit for `LESSON_09`.
...
- verified that the active Repository Object is `LESSON_09`;
...
- **Uncertainty:** Does the result signal doubt or make unsupported claims?
- **Unfamiliarity:** Can you judge it yourself?
- **Volatility:** Could the information have changed?
- **Authority:** Does the task require an official or qualified source?
...
- a fictional birthday-theme suggestion;
- the current hours of a government office;
- a claim about a tax rule affecting a filing;
- a recipe substitution for a casual meal.
...
- current office hours need an official current source;
- tax interpretation may require official guidance or a qualified professional;
...
> AI suggests a local service and says it is open on Sunday, accepts your insurance, and charges $40.

Ask:

> Which claim or claims could materially affect your action, and where would you check them?
...
- planning a visit;
- comparing an ordinary purchase;
- explaining a historical topic;
- drafting a fictional story.

Say:

> Identify what, if anything, needs checking. State the consequence of error, the source or authority you would use, and whether you would proceed now.
...
- material claim identified;
- appropriate checking level chosen;
- independent source or authority named when needed;
- stop decision used when appropriate.

# Lesson Recap

Say:

> Verification is selective, not optional or endless. Check what matters at the level the situation deserves.
...
Capability practiced: Recognizing when independent verification is warranted
Learner artifact: Verification-triage record
Memory anchor: Check more when being wrong matters more.
```
