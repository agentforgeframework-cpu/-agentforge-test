...
AF-001 is tool-neutral and Human-in-Command. The AI facilitates the course, the repository supplies the instructional authority, and the learner retains judgment, responsibility, and control.
...
Only lessons listed and verifiable through `LIBRARY.md` are available for delivery.
